                        ...
                        <tr id="idOrder-{{ $order['id'] }}">
                            ...
                            <td>{{ $order['status'] }}</td>
                                <td style="width: 60px;text-align: center">
                                    <a href="{{ route('databases.editOrdersForm', ['id' => $order['id']]) }}" class="editOrder" id="{{ $order['id'] }}" title="Изменить строку" style="display: inline-table;}"><img style="display: -webkit-inline-box;height: 20px; width: 20px;margin-right: 20px;" src="/images/edit.png"></a>
                                    @can('view', auth()->user())
                                    <a class="deleteOrder" id="{{ $order['id'] }}" title="Удалить строку" style="display: inline-table;}"><img style="display: -webkit-inline-box;height: 20px; width: 20px" src="/images/minus.png"></a>
                                    @endcan
                                </td>
                        </tr>
                    @endforeach
