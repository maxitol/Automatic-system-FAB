    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    ...
                    <form  method="post" action="{{ route('reportDateDocumentSend') }}" class="p-6">
                        @csrf
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <p style="font-size: 20px">{{ __('Количество выполненных заказов за период: ' . count($orderFinish))}}</p>
                <hr>
